  ...
  return (
    ...
    >
      ...
      <div className="relative space-y-2">
        <span className="type-caption font-semibold uppercase tracking-[0.3em] text-slate-500">
          Welcome back
        </span>
        <h2 className="type-title-l font-semibold tracking-tight text-slate-900">
          Access your trading workspace
        </h2>
        <p className="type-subhead text-slate-500">
          Enter your credentials to continue to the command center.
        </p>
      </div>

      <div className="relative space-y-1">
        <label htmlFor="email" className="type-caption font-medium text-slate-600">
          Email address
        </label>
        <input
          id="email"
          ...
          className="w-full rounded-xl border border-slate-200/80 bg-white px-3 py-3 type-subhead font-medium text-slate-900 shadow-sm transition focus:border-transparent focus:outline-none focus:ring-2 focus:ring-sky-400/70"
          placeholder="name@company.com"
        />
      </div>

      <div className="relative space-y-1">
        <label htmlFor="password" className="type-caption font-medium text-slate-600">
          Password
        </label>
        <div className="relative">
          <input
            ...
            className="w-full rounded-xl border border-slate-200/80 bg-white px-3 py-3 pr-12 type-subhead font-medium text-slate-900 shadow-sm transition focus:border-transparent focus:outline-none focus:ring-2 focus:ring-sky-400/70"
            placeholder="Enter your password"
          />
          <button
            type="button"
            onClick={() => setShowPassword((previous) => !previous)}
            className="absolute inset-y-0 right-2 flex items-center rounded-lg px-3 type-caption font-semibold text-slate-500 transition hover:text-slate-900 focus:outline-none focus:ring-2 focus:ring-sky-400/70"
      ...
      <div className="relative type-caption text-slate-500">
