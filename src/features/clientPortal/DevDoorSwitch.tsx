...
export function DevDoorSwitch({ role }: { role: Door }) {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-[90] flex items-center gap-2 rounded-xl border border-dashed border-border-default bg-bg-surface-1/90 px-3 py-1.5 font-mono text-[11px] shadow-lg backdrop-blur">
